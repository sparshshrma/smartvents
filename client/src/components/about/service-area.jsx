...
const service_data = [
    {
        ...
        title: "Smart Systems",
        description: <>Smart vent services often include the ability to create and manage automated schedules for opening and closing vents.</>,
    },
    {
        id: 2,
        icon: "flaticon-security-camera",
        title: "Remote Control",
        description: <>Smart vent services typically offer remote control capabilities through smartphone apps or web portals.</>,
    },
    {
        id: 3,
    ...
    },
    {
        ...
        description: <>or households with multiple users, smart vent services may offer user management features, allowing different...</>,
    },
]

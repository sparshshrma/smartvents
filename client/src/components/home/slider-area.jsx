...
const slider_data = [
    {
        id: 1,
        bg_img: "/assets/img/slider/svent-home.jpg",
        bg_title: "SVent",
        subtitle: "Best smart vent services in canada",
        title: "Uncover the Best House Ventilation System for you",
    },

    {
        id: 2,
        bg_img: "/assets/img/slider/svent-home-1.jpg",
        bg_title: "SVent",
        subtitle: "Best smart vent services in canada",
        title: "Uncover the Best House Ventilation System for you",
    },
                                        ...
                                        <div className="row text-center">
                                            <div className="col-xl-8 m-auto">
                                                ...
                                                <div className="tp-slide-btn-box-3 d-flex flex-wrap justify-content-center">
                                                    ...
                                                    <div className="slider-btn">
                                                        <Link href="/install" className="tp-btn">Installation</Link>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
